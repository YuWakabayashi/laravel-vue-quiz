      ...
      <div class="container">
        <article class="col-md-8 col-xs-12">
          ...
          <section class="home-quiz__ranking">
            ...
            <div>
              <label>
                <input class="ranking-radio" type="radio" name="ranking-radio" v-model="rankingType" value="1" checked />総合
              </label>
              <label>
                <input class="ranking-radio" type="radio" name="ranking-radio" v-model="rankingType" value="2" />今月
              </label>
              <label>
                <input class="ranking-radio" type="radio" name="ranking-radio" v-model="rankingType" value="3" />今週
              </label>
            </div>
